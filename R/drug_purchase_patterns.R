...
#' @param data data.frame of drug events for multiple VNRs as returned by get_drug_events()
...
#' @param purchases data.frame of drug events for a single VNR as returned by get_drug_events().
